		...
		<form name="ctl00" method="post" action="regist.action" id="f">
			...
			<table class="tab_login">
				...
				<tr>
					...
					<td><input name="user.nickname" type="text" id="txtNickName"
						class="text_input" />
				...
				<tr>
					<td valign="top" class="w1">确认密码：</td>
				...
				<tr>
					...
					<td><input name="number" type="text" id="txtVerifyCode"
						class="yzm_input" /> <img class="yzm_img" id='imgVcode' src="#" />
						<div class="text_left t1">
							<p class="t1">
								<span id="vcodeValidMsg">请输入图片中的四个字母。</span>
								 <a id="number_info"  href="#">看不清楚？换个图片</a>
							</p>
						</div></td>
				</tr>
			</table>
